...
- (instancetype)initWithFrame:(CGRect)frame dataSource:(id<AGEmojiKeyboardViewDataSource>)dataSource {
  ...
  if (self) {
    ...
    UIView *lineA = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIScreenWidth, 1)];
    ...
    self.bgBarView = [[UIView alloc] initWithFrame:CGRectMake(0, 171, UIScreenWidth, 45)];
    ...
    UIView *lineB = [[UIView alloc] initWithFrame:CGRectMake(0, 171, UIScreenWidth, 1)];
